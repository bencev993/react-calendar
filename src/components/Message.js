...
// TODO create message depends on error/success
  return (
    <div className="alert">
        {type
        ?   <div className="max-w-full sm:w-1/2 absolute left-1/4 top-1/4 bg-btn-success rounded-lg py-5 px-6 mb-3 text-base inline-flex items-center" role="alert">
        ...
        :  <div className="max-w-full sm:w-1/2 absolute left-1/4 top-1/4 bg-btn-danger rounded-lg py-5 px-6 mb-3 text-base inline-flex items-center" role="alert">
